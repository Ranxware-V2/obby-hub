...
if hub.PlaceId == 8003084678 then
	...
	obbyhub:Destroy()
	getgenv().Loaded = true
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Ranxware-V2/obby-hub/main/Games/1-lua.lua?token=GHSAT0AAAAAABYTGDPAVER5Y23QFJ37QRUIY3Z3AJA",true))()
else
